...
<br>In addition, to combat random pointer jumps, an option to freeze the cursor for a customizable time after dragging, was added.

![Example Setting](Setting.png)